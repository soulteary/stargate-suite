...
type composeGenOptionsJSON struct {
	...
	PortWardenRedis               string            `json:"portWardenRedis"`
	...
	PortHeraldDingtalk            string            `json:"portHeraldDingtalk"`
	PortOwlmail                   string            `json:"portOwlmail"`
	PortStargate                  string            `json:"portStargate"`
...
var optionToComposeGenJSONSetters = map[string]func(*composeGenOptionsJSON, interface{}){
	...
	"portWardenRedis":        func(o *composeGenOptionsJSON, v interface{}) { o.PortWardenRedis = optStr(v) },
	...
	"portHeraldDingtalk":     func(o *composeGenOptionsJSON, v interface{}) { o.PortHeraldDingtalk = optStr(v) },
	"portOwlmail":            func(o *composeGenOptionsJSON, v interface{}) { o.PortOwlmail = optStr(v) },
	"portStargate":           func(o *composeGenOptionsJSON, v interface{}) { o.PortStargate = optStr(v) },
}
...
func reqOptionsToComposegen(o *composeGenOptionsJSON) *composegen.Options {
	...
	opts.PortWardenRedis = strings.TrimSpace(o.PortWardenRedis)
	...
	opts.PortHeraldDingtalk = strings.TrimSpace(o.PortHeraldDingtalk)
	opts.PortOwlmail = strings.TrimSpace(o.PortOwlmail)
	opts.PortStargate = strings.TrimSpace(o.PortStargate)
